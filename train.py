...
Usage:
    $ python train.py --data custom.yaml --weights weights/yolov3-spp.pt --img 640 --adam --freeze 1 --epochs 50
    $ python train.py --data custom.yaml --weights weights/non_freeze_50.pt --img 640 --adam --freeze 1 --epochs 50
    $ python path/to/train.py --data custom.yaml --weights yolov3.pt --img 640
